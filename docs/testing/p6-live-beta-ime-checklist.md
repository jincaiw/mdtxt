...
| --- | --- | --- |
| macOS | Simplified Pinyin and one Japanese IME | Manual pass or explicit unverified note |
...
2. Compose a multi-character Chinese phrase inside a heading, emphasis, list,
   task item and inline-code-adjacent prose. Repeat with Japanese composition
