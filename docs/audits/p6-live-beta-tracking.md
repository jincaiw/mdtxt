...
| Restricted Live structural admission | `bun run test -- src/editor/live/liveEligibility.test.ts` | 4 tests passed: UTF-8 byte limits, line/complex limits, and literal image-shaped inline code does not count as a complex block |
