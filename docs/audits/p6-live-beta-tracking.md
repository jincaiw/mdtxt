...
| 1 MiB / 10 MiB method | `bun run benchmark:live-editor` | Method ready; input-latency and restricted-Live measurements pending |
...
1. P6c: unified focus/composition resolver and native-WebView IME, selection, clipboard, undo/redo and mode/tab-switch evidence.
2. P6d: measured input latency plus explicit restricted-Live eligibility, visible degradation state and 10 MiB evidence.
