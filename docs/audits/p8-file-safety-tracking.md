...
| Frontend release gates | `bun run test && bun run build && bun run release:check` | Passed: 46 files / 316 tests, production build, and preflight (`mdtxt` `0.1.0`; 438 Chinese keys / 97 source files; 0 direct user-copy literals) |
