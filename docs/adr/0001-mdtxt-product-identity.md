...
- Status: accepted
- Date: 2026-07-15
- Amended: 2026-07-30 (v0.4.3)

## Decision

The shipped product is named `mdtxt` (always lowercase), versioned as `0.4.3`,
...
generation remain removed for the v0.4.3 unsigned release. A later release may add
