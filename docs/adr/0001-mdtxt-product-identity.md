...
- Status: accepted
- Date: 2026-07-15
- Amended: 2026-07-29 (v0.3.0)

## Decision

The shipped product is named `mdtxt` (always lowercase), versioned as `0.3.0`,
...
generation remain removed for the v0.3.0 unsigned release. A later release may add
