...
- Status: accepted
- Date: 2026-07-15
- Amended: 2026-07-28 (v0.2.2)

## Decision

The shipped product is named `mdtxt` (always lowercase), versioned as `0.2.2`,
...
generation remain removed for the v0.2.2 unsigned release. A later release may add
