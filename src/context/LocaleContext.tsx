...
const zhCN = {
    ...
    "Focus mode": "专注模式",
    "Dim other paragraphs and collapse distractions": "淡化其他段落并收起干扰界面",
    "Disable Focus mode": "关闭专注模式",
    "Enable Focus mode": "开启专注模式",
    "Navigation sidebar": "导航侧栏",
    "Articles": "文章",
    "File tree": "文件树",
    "Show articles": "显示文章列表",
    "Show file tree": "显示文件树",
    "Copy as Markdown": "复制为 Markdown",
    "Paste as plain text": "粘贴为纯文本",
    "Jump to selection": "跳转到选区",
    "Could not copy Markdown selection": "无法复制 Markdown 选区",
    "Could not read plain text from clipboard": "无法从剪贴板读取纯文本",
    "Image": "图片",
    "Insert image": "插入图片",
    "Open navigation sidebar": "打开导航侧栏",
    "Close navigation sidebar": "关闭导航侧栏",
    "Resize navigation sidebar": "调整导航侧栏宽度",
    ...
    "Model": "模型",
    "API key": "API 密钥",
    "API key could not be saved to the system keychain. It is kept only for this session.": "API 密钥无法保存到系统钥匙串，仅在本次会话中临时保留。",
    ...
    "Connection OK": "连接成功",
    "Clear AI configuration": "清除 AI 配置",
    "Configure an AI endpoint in Settings → AI first.": "请先在“设置 → AI”中配置 AI 端点。",
    "AI endpoint must be a valid http:// or https:// URL.": "AI 端点必须是有效的 http:// 或 https:// URL。",
    "AI model is not configured.": "尚未配置 AI 模型。",
    "API key is invalid or unauthorized. Check Settings → AI.": "API 密钥无效或未获授权，请检查“设置 → AI”。",
    "AI endpoint was not found. Check Settings → AI.": "未找到 AI 端点，请检查“设置 → AI”。",
    "AI service is rate limited. Wait a moment and try again.": "AI 服务请求过于频繁，请稍后重试。",
    "AI service is unavailable. Try again later.": "AI 服务暂时不可用，请稍后重试。",
    "AI request timed out. Try again.": "AI 请求超时，请重试。",
    "AI service returned an empty response.": "AI 服务返回了空响应。",
    "AI request failed. Check the endpoint and try again.": "AI 请求失败，请检查端点后重试。",
    "AI request cancelled.": "AI 请求已取消。",
    "context truncated": "上下文已截断",
    "Only the first {count} document characters will be sent.": "仅发送文档前 {count} 个字符。",
    "A minimal markdown editor": "一款简洁的 Markdown 编辑器",
    "Focused Markdown writing": "专注 Markdown 写作",
    "More": "更多",
    "Drop files here to open": "拖拽文件到此处打开",
    "Supports .md, .txt, and .markdown": "支持 .md、.txt、.markdown",
    ...
    "Code editor": "源码编辑器",
    "Live mode": "Live 模式",
    "Live Markdown editor": "Live Markdown 编辑器",
    "Live": "Live",
    "Limited Live: ": "受限 Live：",
    "File moved to Trash; its open tab is now an unsaved buffer": "文件已移至废纸篓；打开的标签页现为未保存缓冲区",
    "File actions": "文件操作",
    "Open folder": "打开文件夹",
    "New Markdown file": "新建 Markdown 文件",
    "New folder": "新建文件夹",
    "Open a folder to manage a Markdown workspace.": "打开文件夹以管理 Markdown 工作区。",
    "Image asset directory": "图片资源目录",
    "Relative to each Markdown document; default: images": "相对于每个 Markdown 文档；默认：images",
    ...
    "Type to search every markdown file in the current workspace.": "输入内容，搜索当前工作区中的所有 Markdown 文件。",
    "Searching…": "正在搜索…",
    "No matches.": "没有匹配项。",
    ...
    "Could not discard the recovery backup. Please try again.": "无法丢弃恢复备份，请重试。",
    ...
    "Fullscreen on — press F11 to exit": "已进入全屏 — 按 F11 退出",
    "Fullscreen on — press Cmd+Option+F to exit": "已进入全屏 — 按 Cmd+Option+F 退出",
    ...
    "Close table of contents": "关闭大纲",
    "Open table of contents": "打开大纲",
    ...
    "Keyboard shortcuts": "键盘快捷键",
    "AI assist (Alt+Shift+J)": "AI 辅助（Alt+Shift+J）",
    "Slash commands": "斜杠命令",
    "Quote": "引用",
    "Table": "表格",
    "Divider": "分隔线",
    ...
    "This opens the file explorer. It lists every markdown file next to the one you're editing, so you can jump between notes without leaving mdtxt. (Ctrl/Cmd+Shift+L)": "这里会打开文件浏览器，列出当前笔记旁的所有 Markdown 文件，让你无需离开 mdtxt 即可切换笔记。（Ctrl/Cmd+Shift+L）",
    ...
    "This is the table of contents. Every heading you write shows up here, and it tracks where you are as you scroll. Click any heading to jump straight to it. (Ctrl+Shift+1 on Windows/Linux; Cmd+Ctrl+1 on macOS)": "这里是目录。你写下的每个标题都会显示在这里，并随滚动追踪当前位置。点击标题即可跳转。（Windows/Linux：Ctrl+Shift+1；macOS：Cmd+Ctrl+1）",
    ...
    "Use Ctrl+P on Windows/Linux or Cmd+Shift+O on macOS to open files quickly. The command palette is available with Ctrl/Cmd+Shift+P.": "Windows/Linux 按 Ctrl+P、macOS 按 Cmd+Shift+O 可快速打开文件；命令面板使用 Ctrl/Cmd+Shift+P。",
    ...
    "Close (Esc)": "关闭（Esc）",
    "Source (Ctrl/Cmd+/)": "源码（Ctrl/Cmd+/）",
    "Files (Ctrl+Shift+E)": "文件（Ctrl+Shift+E）",
    "Files (Ctrl/Cmd+Shift+L)": "文件（Ctrl/Cmd+Shift+L）",
    "Table of Contents (Ctrl+Shift+O)": "大纲（Ctrl+Shift+O）",
    "Table of Contents (Ctrl/Cmd+Shift+1)": "大纲（Ctrl/Cmd+Shift+1）",
    "Open Quickly": "快速打开",
    "Search files…": "搜索文件…",
    "Search files": "搜索文件",
    "More workspace actions": "更多工作区操作",
    "Switch to Live Preview": "切换到实时预览",
