...
v0.4.3 通过 mdtxt 专属仓库提供 macOS、Windows x64 与 Ubuntu LTS x64 正式包，
并附统一校验和、SPDX SBOM 与第三方许可证清单。所有文件名均带 `-unsigned`，
不包含 macOS 签名/公证或 Windows Authenticode 签名；自动更新保持关闭。详见
